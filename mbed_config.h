 ...
 *
 * Some of the configuration defines might have been changed and can be
 * identified by a "// MICROBIT CHANGE:" comment.
...
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC                                     NRF_LF_SRC_RC                                                                                    // set by target:NRF52_MICROBIT_v1_41

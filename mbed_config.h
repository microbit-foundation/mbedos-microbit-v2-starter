 ...
 *
 * Some of the configuration defines have been changed and can be identified by
 * a "// MICROBIT CHANGE:" comment.
 * Any changes here should also be reflected in the mbed_app.json file.
 ******************************************************************************/
...
// MICROBIT CHANGE: Configures the internal Low Frequency clock to the internal RC clock
// Select Low Frequency clock source. Options: NRF_LF_SRC_XTAL, NRF_LF_SRC_SYNTH, and NRF_LF_SRC_RC
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC                                     NRF_LF_SRC_RC                                                                                    // set by target:MCU_NRF52832

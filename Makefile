# File automagically generated by the Mbed Online Compiler project exporter.
#
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1557754355.52
...
# MICROBIT CHANGE: Removing this flag to disable PINRESET (also done in mbed_app.json)
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1557754355.52
...
ASM_FLAGS += -include
# MICROBIT CHANGE: Bug fix from Mbed Online project exporter https://github.com/ARMmbed/mbed-os/issues/9816

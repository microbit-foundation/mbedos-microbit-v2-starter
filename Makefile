# This file was automagically generated by the Mbed Online Compiler project
# exporter.
# Minor changes were made with some bug fixes, these are identified by a
# "# MICROBIT CHANGE:" comment, check the git history for more info.
#
...
COMPILER_BIN_PATH := ''
#
# Everything below this line was part of the original Makefile and shouldn't

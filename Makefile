...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL/headers
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL/headers/nrf52
...
PREPROC = $(COMPILER_BIN_PATH)arm-none-eabi-cpp -E -P -Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DSOFTDEVICE_PRESENT=1 -DMBED_APP_START=0x22000 -DMBED_APP_SIZE=0xde000 -DMBED_BOOT_STACK_SIZE=2048
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1570543141.115538
...
C_FLAGS += -DNRFX_RNG_ENABLED=1
C_FLAGS += -DNRF_QUEUE_ENABLED=1
C_FLAGS += -DRNG_ENABLED=1
...
C_FLAGS += -DBOOTLOADER2_SIZE=0x22000
C_FLAGS += -DAPPLICATION_ADDR=0x22000
C_FLAGS += -DAPPLICATION_SIZE=0xde000
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1570543141.115538
...
CXX_FLAGS += -DNRFX_RNG_ENABLED=1
CXX_FLAGS += -DNRF_QUEUE_ENABLED=1
CXX_FLAGS += -DRNG_ENABLED=1
...
CXX_FLAGS += -DBOOTLOADER2_SIZE=0x22000
CXX_FLAGS += -DAPPLICATION_ADDR=0x22000
CXX_FLAGS += -DAPPLICATION_SIZE=0xde000
...
ASM_FLAGS += -DNRFX_RNG_ENABLED=1
ASM_FLAGS += -DNRF_QUEUE_ENABLED=1
ASM_FLAGS += -DRNG_ENABLED=1
...
ASM_FLAGS += -I..
ASM_FLAGS += -I../TARGET_NRF52_MICROBIT_v1_43
ASM_FLAGS += -I../mbed-os
...
ASM_FLAGS += -I../mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL
ASM_FLAGS += -I../mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL/headers
ASM_FLAGS += -I../mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL/headers/nrf52
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DSOFTDEVICE_PRESENT=1 -DMBED_APP_START=0x22000 -DMBED_APP_SIZE=0xde000 -DMBED_BOOT_STACK_SIZE=2048 
...
$(PROJECT)-combined.hex: $(PROJECT).hex
	...
	$(SREC_CAT) .././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_SDK_14_2/TARGET_SOFTDEVICE_S140_FULL/hex/s140_nrf52840_5.0.0-2.alpha_softdevice.hex  -intel $(PROJECT).hex -intel -o $(PROJECT)-combined.hex -intel --line-length=44
